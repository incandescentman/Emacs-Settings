...
** PLEASE-TEST [#A] inserting smart-punctuation when there's already a space between the word and the point 
...
** PLEASE-TEST [#A] [[file:shared-functions.org::*erika-send-email-styled][erika-send-email-styled]] (I changed my setup, which broke this function. See my note in the other file)
...
**** PLEASE-TEST [#A] smart-punctuation when there's already a misplaced punctuation mark?
