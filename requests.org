...
** TODO [#A] [[file:shared-functions.org::*new-email-from-subtree][new-email-from-subree]]
** TODO priority B requests
** TODO [#C] kill-clause etc.
** TODO strange behavior with smart-comma (see [[file:smart-punctuation-error.org::*in%20the%20example%20below:][smart-punctuation-error.org]])
...
*** TODO [#B] kill-line-and-capitalize [2/3]
