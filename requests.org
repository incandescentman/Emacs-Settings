...
** DONE [#A] requests.org: smart-punctuation when there's already a correctly placed punctuation mark
** TODO [#A] requests.org: smart-punctuation when there's already a misplaced punctuation mark
** TODO [#A] gnu-emacs-startup.org: changes to defadvice capitalize-word 
...
*** TODO [#A] add to smart-period, smart-question-mark, and smart-exclamation mark
