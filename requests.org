...
* open requests 
** Emacs 
*** DONE [#A] strange behavior with smart-period 
...
In the above example (without the BEGIN_EXAMPLE and END_EXAMPLE delimiters), if the point is after the "s" in "swans" and I hit smart-period, I get strange behavior... 

and this error: https://gist.github.com/fba6c32caf158aac9901
