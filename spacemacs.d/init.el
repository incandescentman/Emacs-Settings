...
(custom-set-faces
 ...
 '(org-transclusion ((t (:extend t :background "cyan" :foreground "black" :inverse-video nil))))
 '(org-transclusion-fringe ((t (:extend t :stipple nil :background "alice blue" :foreground "dark red" :inverse-video t :box (:line-width (2 . 2) :color "grey75" :style released-button)))))
 '(org-transclusion-source-fringe ((t (:extend nil :background "dark red"))))
