(defvar search-link-cmd "/Users/jay/Dropbox/github/searchlink/lib/searchlink.rb")

(defun searchlink (start end)
    "Replace the selected text with a link generated by the searchlink script."
(interactive "r")
...
(final-res (replace-regexp-in-string "&rut=[0-9a-fA-F]\\{64\\}" "" org-mode-res)))
(insert final-res)))
