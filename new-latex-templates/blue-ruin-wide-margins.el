(provide 'blue-ruin-wide-margins)

(add-to-list 'org-latex-classes
  '("blue-ruin-wide-margins"
"

\\documentclass[12pt]{article}
\\usepackage[includeheadfoot,margin=2.0in,hmargin=2.0in,vmargin=0.5in]{geometry}
\\usepackage{float}
...
{\\myauthorfont\\Large © 2016 \\@author}
    \\newline
        ...
        \\newline
          %{\\myauthorfont\\Large \\href{http://newyorkwritersintensive.com}{\\@degree}}
        \\newline
