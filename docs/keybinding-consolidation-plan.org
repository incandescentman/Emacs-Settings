...
| [[file+emacs:/Users/jay/emacs/emacs-settings/org-roam-config-legacy.el][org-roam-config-legacy.el]]        | ~27                                    | ~s-u~ prefix map for org-roam                    |
...
- macOS reserved keys: treat =s-d= as unavailable (bound to Command-Tab app switcher).
...
- Third-party / vendored package files: ~dired+.el~, ~frame-cmds.el~, ~buffer-stack.el~, ~pomidor.el~, ~key-seq.el~, ~ivy-smex.el~, ~wc-goal-mode.el~, ~forecast.el~, ~elpa-supplement/auto-capitalize.el~ — these define their own mode-specific maps, not Jay's global bindings
- [[file+emacs:/Users/jay/emacs/emacs-settings/timeline/][timeline/*.el]] — self-contained calendar-mode-map bindings
- [[file+emacs:/Users/jay/emacs/emacs-settings/archive/aibo-config.el][archive/aibo-config.el]] / [[file+emacs:/Users/jay/emacs/emacs-settings/archive/aibo-power-pack.el][archive/aibo-power-pack.el]] — internal mode maps
...
5. [[file+emacs:/Users/jay/emacs/emacs-settings/org-roam-config-legacy.el][org-roam-config-legacy.el]] — ~27 bindings
