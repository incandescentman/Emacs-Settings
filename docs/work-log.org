...
** Summary
- Renamed the project from “markdown-diary” to “timeline”, including the module, docs, and ideas notebook.
- Moved `timeline.el`, the keybinding cheatsheet, and the README into `timeline/` to keep calendar tooling grouped.
- Pointed the diary file reference to `~/Dropbox/github/timeless/data/timeline.md` across docs and code.
- Updated references throughout the documentation to target the new directory and naming.
