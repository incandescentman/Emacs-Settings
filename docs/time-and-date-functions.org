...
Creates a heading with bookwriting TODO and starts a prolific sprint (via =pomodoro-start= wrapper).

** pomidor-start (line 1272)

Compatibility alias for =jd-org-today-and-book= behavior; also starts a prolific sprint.

** jd-pomodoro-sprint (line 1281)

Creates a heading with "pomodoro sprint" TODO and starts a prolific sprint.
