...
- *Markdown signals*: `^#` headings, `- `/`* ` bullets, ordered lists, blockquotes, fenced code, inline links, `**bold**`
- *Org signals*: `#+` directives, TODO keywords, property drawers, multi-star headings
...
3. If style is markdown: =pasteboard--convert-asterisk-bullets-to-dashes=
4. Final sweep converting remaining `* ` to `- `
