...
| =s-u 3= | Switch to relationships (roam-social) profile |
| =s-u 4= | Switch to parents/family HQ (roam-parents) profile |
...
- =[Roam:Social]= - You're in relationships mode
- =[Roam:Parents]= - You're in family HQ mode
...
- *Templates:* Connection logs, event debriefs, follow-up plans, introductions, people snapshots
- *Use for:* Tracking community energy, logging dinners/events, planning outreach

** Roam-Parents (Family HQ)
- *Location:* =~/Dropbox/roam-parents/=
- *Database:* =~/Dropbox/roam-parents/.org-roam.db=
- *Templates:* Care logs, medical notes, appointments, parent dossiers, support reflections, errands
- *Use for:* Coordinating family/parent care, keeping medical histories and next actions in one spot
...
- Personal time? =s-u 2=
- Community/relationships block? =s-u 3=
- Parent care logistics? =s-u 4=
...
** Backup Everything
Since you now have four independent directories, make sure all of them are backed up:
- =~/Dropbox/roam/= (work)
- =~/Dropbox/roam-life/= (personal)
- =~/Dropbox/roam-social/= (relationships)
- =~/Dropbox/roam-parents/= (family HQ)

If you use Dropbox (as configured), each tree will sync separately—double-check shared devices have the new folders enabled.
