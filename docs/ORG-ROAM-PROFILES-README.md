...
3. **Supporting environment ownership** - Spellcheck now lives in `spellcheck.org`, export-specific XeLaTeX settings live in `org-export.org`, and startup-owned environment setup stays outside the suite.
