...
(custom-set-variables
 ...
 '(nxml-default-buffer-file-coding-system (quote utf-8-unix))
 '(only-global-abbrevs t)
 '(openwith-associations (quote (("\\.pdf\\'" "Skim" (file)) ("\\.mp3\\'" "xmms" (file)) ("\\.\\(?:mpe?g\\|avi\\|wmv\\)\\'" "mplayer" ("-idx" file)) ("\\.\\(?:jp?g\\|png\\)\\'" "display" (file)))))
 '(org-M-RET-may-split-line (quote ((item . t))))
 '(org-activate-links (quote (bracket plain radio tag date footnote)))
 '(org-agenda-files (quote ("~/Dropbox/writing/notationaldata/prolific.org" "~/Dropbox/writing/book/proposal/book-meta.txt" "~/Dropbox/writing/notationaldata/playful.org")))
