...
(setq org-pomodoro-short-break-sound ""/Users/jay/Dropbox/audio/sounds/Horse-Gallop.mp3"")
...
(setq recentf-save-file "/Users/jay/Dropbox/Apps/Emacs/savefile/recentf") ; don't know why this doesn't work 
...
;; (define-hyper-key "j a" 'org-agenda)
(define-hyper-key "j j" 'helm-imenu-anywhere)
;; (define-hyper-key ";" 'ido-goto-symbol)
;; (define-hyper-key ";" 'helm-resume)
(define-hyper-key "D" 'diredp-dired-recent-dirs)

(define-hyper-key "j cy" 'cyberpunk-jay)
(define-hyper-key "j cl" 'cyberpunk-large)
(define-hyper-key "j zb" 'zenburn)
(define-hyper-key "j le" 'leuven)
(define-hyper-key "j ts" 'transparent-serenity)
(define-hyper-key "j tg" 'top-gun-mode)
(define-hyper-key "j tn" 'tomorrow-night)

(define-hyper-key "j ma" 'inverse-add-global-abbrev) 

(define-hyper-key "j rr" 'replace-regexp) 


(define-hyper-key "j cf" 'customize-face) 

(define-hyper-key "j h" 'org-export-dispatch)




(define-hyper-key "j nm" 'notmuch-hello) 
(define-hyper-key "j mu" 'mu4e)

;; (define-hyper-key "j cl" 'cyberpunk-large)

(define-hyper-key "j dd" 'delete-duplicate-lines-keep-blanks) 

(define-hyper-key "j cw" 'cyberpunk-writeroom)
(define-hyper-key "j wb" 'whiteboard)
(define-hyper-key "j sl" 'solarized-light)
(define-hyper-key "j sd" 'solarized-dark)
(define-hyper-key "j ri" 'ritchie)
(define-hyper-key "j sp" 'spolsky)
(define-hyper-key "j wr" 'writeroom-mode)
(define-hyper-key "j wf" 'workflowy-mode)
(define-hyper-key "j st" 'small-type)
(define-hyper-key "j mp" 'morning-pages)
(define-hyper-key "j rf" 'prelude-rename-file-and-buffer)
(define-hyper-key "j lt" 'large-type)
(define-hyper-key "j mt" 'medium-type)
(define-hyper-key "j df" 'prelude-delete-file-and-buffer)

(define-hyper-key "j bl" 'blue-light)

(define-hyper-key "j eu" 'endless/upgrade)


;; accountability

(define-hyper-key "j ek" 'erika-send-email-styled)
...
(define-hyper-key "j kb" 'keybinding-read-and-insert)
(define-hyper-key "j mk" 'keybinding-read-and-insert)
