...
(setq auto-capitalize-words '("fn" "I" "setq" "iPhone" "IPad" "ediff" "btw" "nyc" "file" "http" "provide" "load" "require" "alias" "looking-at" "if" "blockquote" "http" "eBay"))
...
(cheatsheet-add :group 'Search 
                :key "SS"
                :description "helm-multi-swoop-org") 
