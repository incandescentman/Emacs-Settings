...
(defun org-show-level-1 () 
  (interactive) 
 (org-content 1)) 
(define-key key-minor-mode-map (kbd "s-!") 'org-show-level-1)
 (defun org-show-level-2 () 
  (interactive) 
 (org-content 2)) 
(define-key key-minor-mode-map (kbd "s-@") 'org-show-level-2)
 (defun org-show-level-3 () 
  (interactive) 
 (org-content 3)) 
(define-key key-minor-mode-map (kbd "s-#") 'org-show-level-3)
 (defun org-show-level-4 () 
  (interactive) 
 (org-content 4)) 
(define-key key-minor-mode-map (kbd "s-$") 'org-show-level-4)
 (defun org-show-level-5 () 
  (interactive) 
 (org-content 5)) 
(define-key key-minor-mode-map (kbd "s-%") 'org-show-level-5)
 (defun org-show-level-6 () 
  (interactive) 
 (org-content 6)) 
(define-key key-minor-mode-map (kbd "s-^") 'org-show-level-6)
 (defun org-show-level-7 () 
  (interactive) 
 (org-content 7)) 
(define-key key-minor-mode-map (kbd "s-$") 'org-show-level-7)
