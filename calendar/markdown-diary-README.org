...
* Diary Buffer Extras
- ~C-SPC~ or ~C-c C-c~ inside ~jay-diary.md~ run =my-diary-return-to-calendar= so you can hop back to the originating calendar date even after editing elsewhere.
