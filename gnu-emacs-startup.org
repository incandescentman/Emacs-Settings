...
#+END_SRC
** TODO modify pasteboard-paste above so that it will remove extra whitespace BEFORE pasted word 
...
Currently, my/fix-space will (1) leave only one space; (2) do not leave an extra space at the beginning of the line. 

Goal: to make it so that that my/fix-space also (3) makes sure not to leave a space between a word and a punctuation mark. 

Examples: 

Lorem ipsum delete delete , consectetur adipiscing elit.  
  
Ut enim ad minim veniam, delete delete .  
  
Ut enim ad minim veniam, delete delete ?  
  
Tried this, it doesn't work. I don't really know what I'm doing. 
...
(defun backward-kill-word-correctly ()
  ...
  (my/fix-space))
#+END_SRC
*** TODO count punctuation such as , . ; ? ! as a word. 
Example:
: The quick brown, fox ^ fox jumped.

Goal: 
Suppose If point is at ^ caret above. I want to be able to invoke backward-kill-word-correctly, twice, such that...

...first invocation should result in this:
: The quick brown, fox jumped.

...and second invocation should result in this:
: The quick brown fox jumped.
