...
This works mostly correctly within sentences. But when I use it at the end of a sentence, it clobbers the period at the end of the sentence.
...
Even worse, if there's no punctuation
