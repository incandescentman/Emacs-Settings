...
* TODO [#A] changes to defadvice capitalize-word                       :rudi:
Rúdi: I want make auto-capitalize-mode downcase next word upon auto-capitalization (I wrote this part already) but WITHOUT going past the line break (I need you to add this part)
...
In other words, I want to instruct auto-capitalize-mode to downcase the next word whenever it auto-capitalizes a word if there is another word after the point before a line break or period? 
