...
Source: [[http://kitchingroup.cheme.cmu.edu/blog/2015/02/02/helm-actions-when-there-is-no-match/][The Kitchin Research Group]]

*** how to write helm functions
    [[http://wikemacs.org/wiki/How_to_write_helm_extensions][How to write helm extensions - WikEmacs]]
    [[http://kitchingroup.cheme.cmu.edu/blog/2015/01/24/Anatomy-of-a-helm-source/][The Kitchin Research Group]]
...
Source: [[http://kitchingroup.cheme.cmu.edu/blog/2014/12/03/Selective-auto-capitalization-in-org-buffers/][The Kitchin Research Group]]
...
Source: [[http://kitchingroup.cheme.cmu.edu/blog/2014/06/08/Better-integration-of-org-mode-and-email/][The Kitchin Research Group]]
...
*** invisible text in Emacs
    [[http://kitchingroup.cheme.cmu.edu/blog/2014/02/06/Invisible-text-in-emacs/][The Kitchin Research Group]]
...
#+END_QUOTE
* TODO smart-org-meta-return-dwim
- remove line break if meta-return when in a heading (i.e. when there is a "*" at the beginning of the line)
