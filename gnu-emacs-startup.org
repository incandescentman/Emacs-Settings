...
(define-key key-minor-mode-map (kbd "s-k r l") 'remove-hyperlink-at-point)
...
(define-key key-minor-mode-map (kbd "C-M-\\") 'palimpsest-move-region-to-top)
...
(define-key key-minor-mode-map (kbd "s-k d l") 'double-line-breaks-in-region)
...
(define-key key-minor-mode-map (kbd "s-x") 'pasteboard-cut-adaptive)
...
(define-key key-minor-mode-map (kbd "s-V") 'pasteboard-paste-verbatim)
...
(define-key minibuffer-local-map (kbd "s-v") 'pasteboard-paste-verbatim)
...
(define-key key-minor-mode-map (kbd "C-s-k") 'kill-unwanted-buffers)
...
(define-key key-minor-mode-map (kbd "M-t") 'mw-thesaurus-lookup-dwim)
...
(define-key key-minor-mode-map (kbd "C-s-SPC") 'cape-emoji)
(define-key key-minor-mode-map (kbd "s-T") 'new-buffer-in-new-pane)
...
(define-key key-minor-mode-map (kbd "s-j") 'org-todo)
...
(define-key key-minor-mode-map (kbd "<s-return>") 'jay/toggle-fullscreen)
 #+END_SRC
