...
* TODO Create an exception to smart-punctuation                        :rudi:
...
#+BEGIN_QUOTE
OK, looks great. I think I'd like it to work in same way for 
#+END_QUOTE


** TODO request: backspace after expand-abbrev 
Hi Rúdi,
