...
* TESTING [#B] cycle-hyphenation for multiple words
...
* TODO [#B] list of abbrevs to be expanded to TextExpander as case-sensitive 
...
* TODO disable cycling between hyphen and ellipsis?
Can you disable this? It's a great idea but I realize there are times when I want to type a long line of 30 periods in a row (without using the number prefix). Thanks!
