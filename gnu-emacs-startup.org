...
*** kill clause This old version leaves a rogue comma:
...
This is mostly correctly within sentences. But when I use it at the end of a sentence, it clobbers the period at the end of the sentence.
...
...where the ^ represents the point...

and I do kill-clause, this is the result:
...
Not a big deal, but ChatGPT having trouble figuring it out.
