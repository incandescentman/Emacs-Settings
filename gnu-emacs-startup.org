...
*** NOTE-TO-RÚDI Answer
Definitely #1. if possible, #1 would be great. #3 could work also. it's just a bit easier to type BACKSPACE 5 times than it is to type it 4 times followed by C-BACKSPACE. but this is also an option if #1 is pretty complicated.


** PLEASE-DEBUG [#B] self insert space                                :rudi:
