...
* TODO backward-kill-word-correctly-and-capitalize 
I created this by imitating the format of kill-word-correctly-and-capitalize. I think it's OK.
...
* Is this a better way to org-modise my init file?                     :rudi:
  ...
  (while (not (eobp))
    ...
    (cond
     ...
     ((looking-at "^\\* ")
      (goto-char (point-max)))))) 
#+END_QUOTE
Source: [[http://endlessparentheses.com/init-org-Without-org-mode.html][init.org Without org-mode · Endless Parentheses]]
