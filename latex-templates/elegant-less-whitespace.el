...
(add-to-list 'org-latex-classes
             '("elegant-less-whitespace"
               "
\\documentclass[11pt]{article}
\\usepackage[includeheadfoot, margin=1in]{geometry} % Set margins
...
\\setlist{noitemsep, topsep=-8pt, after=\\vspace{6pt}} % Control spacing in lists
\\setlistdepth{10}
