;;; beautiful-racket-tabularray.el --- Org LaTeX class -*- lexical-binding: t; -*-

(provide 'beautiful-racket-tabularray)
...
(when (fboundp 'jay/latex-apply-prose-defaults)
  (jay/latex-apply-prose-defaults "beautiful-racket-tabularray"))
