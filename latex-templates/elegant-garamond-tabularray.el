;;; elegant-garamond-tabularray.el --- Org LaTeX class -*- lexical-binding: t; -*-

(provide 'elegant-garamond-tabularray)
...
(when (fboundp 'jay/latex-apply-prose-defaults)
  (jay/latex-apply-prose-defaults "elegant-garamond-tabularray"))
