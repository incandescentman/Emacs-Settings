;;; book-proposal-latex.el --- Org LaTeX class -*- lexical-binding: t; -*-
...
\\newfontfamily\\mytitlefont[Color={niceorange}]{Gotham Narrow Bold}
\\newfontfamily\\myauthorfont[Color={niceorange}]{Gotham Narrow Bold}
...
\\newline
{\\myauthorfont\\Large DO NOT DISTRIBUTE}
\\newline
        \\newline
...
(when (fboundp 'jay/latex-apply-prose-defaults)
  (jay/latex-apply-prose-defaults "book-proposal-latex"))
