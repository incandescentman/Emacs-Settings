;;; new-yorker-caslon.el --- Org LaTeX class without Irvin -*- lexical-binding: t; -*-

(provide 'new-yorker-caslon)
...
\\setromanfont{Adobe Caslon Pro}
 \\setsansfont{Adobe Caslon Pro}
  % Use the body Caslon face for display headings/bylines; this variant avoids Irvin.
  \\newcommand{\\newyorkerdisplayface}{\\rmfamily}
...
(when (fboundp 'jay/latex-apply-prose-defaults)
  (jay/latex-apply-prose-defaults "new-yorker-caslon"))
