...
* local file variables executing lisp code on file open
#+BEGIN_QUOTE
;; Local Variables:
;; eval: (eldoc-mode)
...
exiftool -Author="Todd Shackelford" "/Users/jay/Downloads/Encyclopedia of Evolutionary Psychological Science.pdf"
