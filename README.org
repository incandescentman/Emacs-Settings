...
- [[file:org-roam-config-legacy.el][org-roam-config-legacy.el]] - Legacy compatibility shim (loads the suite; full legacy implementation archived in [[file:archive/org-roam-config.el_legacy_2026-02-24][archive/org-roam-config.el_legacy_2026-02-24]])
...
10. Various feature modules (deferred or immediate)
11. Local configuration (=local-config.el=)
