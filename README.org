...
- [[file:spellcheck.org][spellcheck.org]] - Flyspell, Jinx, Hunspell, and personal dictionary wiring
- [[file:org-export.org][org-export.org]] - Org export, publishing, LaTeX, and clipboard/export helpers
- [[file:spacecraft-mode.org][spacecraft-mode.org]] - Custom writing mode
- [[file:org-authoring.org][org-authoring.org]] - Org-specific heading/list/structure authoring helpers
...
- [[file:jay-osx.el][jay-osx.el]] - macOS-specific settings and early =key-minor-mode-map= setup
...
- [[file:jay-org-roam-suite/][jay-org-roam-suite/]] - **Core Architecture**: Modular Org Roam system (Core, Profiles, Templates, plus extras sidecar)
- [[file:jay-org-roam-suite/jay-org-roam-extras.el][jay-org-roam-extras.el]] - User-facing Org-roam helpers (UI, backlink navigation, refile chooser, parser diagnostics)
...
- [[file:shared-functions.org][shared-functions.org]]: ~316KB (9983 lines)
  - *Do not split casually*: keep general utilities here, but extract a new =.org= module when a subsystem becomes both coherent and clearly out of place. [[file:org-authoring.org][org-authoring.org]], [[file:spellcheck.org][spellcheck.org]], and [[file:org-export.org][org-export.org]] are the current examples of that narrower, intentional split pattern.
