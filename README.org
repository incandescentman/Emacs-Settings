...
- [[file:shared-functions.org][shared-functions.org]]: ~316KB (9983 lines)
  - *Do not split casually*: keep general utilities here, but extract a new =.org= module when a subsystem becomes both coherent and clearly out of place. [[file:org-authoring.org][org-authoring.org]] and [[file:spellcheck.org][spellcheck.org]] are the current examples of that narrower, intentional split pattern.
