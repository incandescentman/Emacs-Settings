...
- [[file:org-roam-config.el][org-roam-config.el]] - Legacy compatibility shim (loads the suite; full legacy implementation archived in [[file:archive/org-roam-config.el_legacy_2026-02-24][archive/org-roam-config.el_legacy_2026-02-24]])
