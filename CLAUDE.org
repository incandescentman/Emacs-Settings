...
- *Respect file ownership boundaries*: [[file+emacs:/Users/jay/emacs/emacs-settings/spacecraft-mode.org][spacecraft-mode.org]] owns prose-editing behavior (sentence movement, sentence killing, kill-word helpers, capitalization/smart punctuation). [[file+emacs:/Users/jay/emacs/emacs-settings/org-authoring.org][org-authoring.org]] owns Org-only authoring helpers (heading insertion, list/checkbox predicates, Org-specific structure editing). [[file+emacs:/Users/jay/emacs/emacs-settings/spellcheck.org][spellcheck.org]] owns Flyspell, Jinx, Hunspell, and personal-dictionary wiring. [[file+emacs:/Users/jay/emacs/emacs-settings/gnu-emacs-startup.org][gnu-emacs-startup.org]] should stay focused on startup/system/editor bootstrapping rather than accumulating writing-mode logic.
- *Future module decisions*: Prefer narrow subsystem files over vague overflow bins. The strongest next candidate is a future [[file+emacs:/Users/jay/emacs/emacs-settings/org-export.org][org-export.org]] module. A future [[file+emacs:/Users/jay/emacs/emacs-settings/dictionary-lookup.org][dictionary-lookup.org]] is plausible if the definition-lookup cluster grows. Avoid creating a generic [[file+emacs:/Users/jay/emacs/emacs-settings/org-workflow.org][org-workflow.org]] until a single coherent subsystem boundary actually emerges.
...
- =shared-functions.org=: ~316KB (9983 lines)
  - *Do not split casually*: keep general utilities here, but extract a new =.org= module when a subsystem becomes both coherent and clearly out of place. [[file+emacs:/Users/jay/emacs/emacs-settings/org-authoring.org][org-authoring.org]] and [[file+emacs:/Users/jay/emacs/emacs-settings/spellcheck.org][spellcheck.org]] are the current examples of that narrower, intentional split pattern.
