...
- *Respect file ownership boundaries*: [[file+emacs:/Users/jay/emacs/emacs-settings/spacecraft-mode.org][spacecraft-mode.org]] owns prose-editing behavior (sentence movement, sentence killing, kill-word helpers, capitalization/smart punctuation). [[file+emacs:/Users/jay/emacs/emacs-settings/gnu-emacs-startup.org][gnu-emacs-startup.org]] should stay focused on startup/system/editor bootstrapping rather than accumulating writing-mode logic.
