...
;;;;; basic coloring
   ...
   `(org-block-begin-line ((t (:background ,zenburn-bg-05 :overline "#A7A7A7"))))
   `(org-block-end-line ((t (:background ,zenburn-bg-05 :underline "#A7A7A7"))))
...
;;;;; hl-line-mode
   `(hl-line-face ((,class (:background ,zenburn-bg-05 :foreground "white"))
                   (t :weight bold)))
   `(hl-line ((,class (:background ,zenburn-bg-05 :foreground "white")) ; old emacsen
              (t :weight bold)))
;;;;; hl-sexp
