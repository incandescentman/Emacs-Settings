...
;;;;; basic coloring
   ...
   `(org-quote ((t (:background ,zenburn-bg-05 :foreground "white"))))
   `(org-code ((t (:background ,zenburn-bg-05 :foreground "white"))))
...
;;;;; isearch
   ...
   `(minibuffer-prompt ((t (:foreground ,zenburn-blue background: ,zenburn-bg))))
   `(mode-line
...
;;;;; dired+
   ...
   `(diredp-directory ((t (:foreground ,zenburn-blue :background ,zenburn-bg-1))))
...
;;;;; org-mode
   ...
   `(org-done ((t (:bold t :weight bold :foreground ,zenburn-green+3 :background ,zenburn-bg))))
...
;; `(org-level-1 ((t (:height 1.3 :weight bold :overline ,zenburn-bg-05 :foreground ,zenburn-orange))))
   ...
   `(org-level-2 ((t (:foreground ,zenburn-green+4 :background ,zenburn-bg))))
   ...
   `(org-level-5 ((t (:foreground ,zenburn-cyan :background ,zenburn-bg))))
   `(org-level-6 ((t (:foreground ,zenburn-green+2 :background ,zenburn-bg))))
   ...
   `(org-special-keyword ((t (:inherit font-lock-comment-face :background ,zenburn-bg))))
   ...
   `(org-upcoming-deadline ((t (:inherit font-lock-keyword-face :background ,zenburn-bg))))
   `(org-warning ((t (:bold t :foreground ,zenburn-red :weight bold :underline nil))))
   `(org-column ((t (:background ,zenburn-bg-1))))
   `(org-document-title ((t (:foreground ,zenburn-green+4 :height 2.0))))
   `(org-document-info ((t (:foreground ,zenburn-red :height 1.5))))
   `(org-column ((t (:background ,zenburn-bg-1))))
   ...
   `(org-ellipsis ((t (:foreground ,zenburn-yellow-1 :underline t :background ,zenburn-bg))))
