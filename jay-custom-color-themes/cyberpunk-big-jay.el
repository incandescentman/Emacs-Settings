...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(cursor ((,class (:background ,cyberpunk-blue-5))))
   ...
   `(highlight ((,class (:background ,cyberpunk-gray-5 :foreground ,cyberpunk-fg))))
   ...
   `(italic ((,class (:foreground ,cyberpunk-red-1) )))
   ...
   `(flymake-errline ((,class (:foreground ,cyberpunk-red-1 :weight bold :underline nil))))
   `(flymake-warnline ((,class (:foreground ,cyberpunk-yellow-1 :weight bold :underline nil))))
   ...
   `(hl-line ((,class (:background ,dark-gray :foreground ,cyberpunk-fg))))
...
`(org-code ((,class (:foreground ,cyberpunk-green-2))))
   ...
   `(org-level-1 ((,class (:foreground ,cyberpunk-jay-light-violetred1 :height 1.7))))
   `(org-level-2 ((,class (:foreground ,cyberpunk-blue-5 :height 1.3))))
   `(org-level-3 ((,class (:foreground ,cyberpunk-green :height 1.2))))
   `(org-level-4 ((,class (:foreground ,cyberpunk-yellow-1 :height 1.1))))
   `(org-level-5 ((,class (:foreground ,cyberpunk-blue-1 :height 1))))
   ...
   `(org-block ((,class ( :background ,dark-gray :underline nil))))
   `(org-block-begin-line 
     ((,class (:foreground "#008ED1" :background ,cyberpunk-black-2))))
