...
(let ((class '((class color) (min-colors 89)))
      ...
      (cyberpunk-jay-pink "#ffc0cb")
      (cyberpunk-jay-light-violetred1 "#ff3e96")
      (cyberpunk-jay-dark "#a63e8c")
  ...
  (custom-theme-set-faces
   ...
   `(link ((,class (:foreground ,cyberpunk-yellow :underline nil :weight bold))))
   ...
   `(highlight ((,class (:background ,dark-gray  :foreground ,hl-fg))))
   ...
   `(region ((,class (:background ,cyberpunk-jay-pink :foreground ,cyberpunk-black ))))

   `(secondary-selection ((,class (:background ,cyberpunk-bg+2 :foreground ,cyberpunk-green+1))))
...
;;   `(font-lock-comment-face ((,class (:foreground ,cyberpunk-blue-5 : nil))))
   ;; `(font-lock-comment-delimiter-face ((,class (:foreground ,cyberpunk-green))))
   `(font-lock-comment-face ((,class (:foreground ,cyberpunk-green-2 : nil))))
   ...
   `(newsticker-extra-face ((,class (:foreground ,cyberpunk-bg+2 :height 1.0))))
...
`(widget-field  ((,class (:background ,cyberpunk-fg :foreground ,cyberpunk-bg))))


'(writegood-weasels-face ((t (:underline (:color "orange" :style wave)))))

'(writegood-passive-voice-face ((t (:underline (:color "orange" :style wave)))))
   ...
   `(helm-source-header
     ((,class (:foreground ,cyberpunk-yellow
                           ...
                           :weight bold
                           :box (:line-width -1 :style released-button)))))
`(helm-selection ((,class (:background ,dark-gray :underline nil   :foreground ,cyberpunk-pink-1))))
   ...
   `(helm-candidate-number ((,class (:foreground ,cyberpunk-green+4 :background ,dark-gray))))

   ;; hl-line-mode
   `(hl-sexp-face ((,class (:background ,cyberpunk-gray-5 :foreground ,cyberpunk-red-1))))
   `(hl-line-face ((,class (:background ,dark-gray  :foreground ,hl-fg))))
   `(hl-line ((,class (:background ,dark-gray :foreground ,hl-fg))))
   ...
   `(jabber-title-small ((,class (:height 1 :weight bold))))
   `(jabber-title-medium ((,class (:height 1 :weight bold))))
   `(jabber-title-large ((,class (:height 1 :weight bold))))
...
`(org-code ((,class (:foreground ,cyberpunk-green-2))))
   ...
   `(org-checkbox ((,class (:background ,cyberpunk-gray-2 :foreground ,cyberpunk-red-1
                                        :box (:line-width 1 :style released-button)))))
   `(org-date ((,class (:foreground ,cyberpunk-blue-7 :underline nil))))
...
;; `(org-todo ((,class (:bold t :foreground ,cyberpunk-blue-5 :weight bold  ))))
   ...
   `(org-level-1 ((,class (:foreground ,cyberpunk-jay-light-violetred1 :height 1.0))))
`(org-level-2 ((,class (:foreground ,cyberpunk-green+1 :height 1.0))))
`(org-level-3 ((,class (:foreground ,cyberpunk-blue-5 :height 1.0))))
   `(org-level-4 ((,class (:foreground ,cyberpunk-yellow-1))))
   `(org-level-5 ((,class (:foreground ,cyberpunk-blue-1))))
 ...
 ;;  `(org-link ((,class (:foreground ,cyberpunk-blue-6 :underline t))))
  `(org-link ((,class (:foreground ,cyberpunk-blue-6 :underline nil))))
   ...
   `(org-hide ((,class (:foreground ,cyberpunk-bg))))
