...
;;         (base0     "#000000")
       (base00    "#657b83")
         ...
         ;; comments  (base00    "#657b83") (base0     "#839496")
         (base1     "#93a1a1")
         ...
         (solarized-bright (if (eq variant 'light) base03 base3))
         (solarized-emph (if (eq variant 'light) base01 base1))
         (solarized-comments (if (eq variant 'light) magenta-d  magenta-l))
    ...
    (custom-theme-set-faces
     ...
     `(cursor ((,class (:foreground ,red :background ,red :inverse-video t))))
     ...
     ;; hl-line-mode
     `(hl-line ((,class (:background ,solarized-hl :foreground ,solarized-bright))))
     `(hl-line-face ((,class (:background ,solarized-hl  :foreground ,solarized-bright))))
