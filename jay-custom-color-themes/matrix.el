...
(jay-gray "#595959"))
  ...
  (custom-theme-set-faces
   ...
   ;; basic coloring
   `(default ((,class (:foreground ,cyberpunk-green :background ,cyberpunk-black))))
   ...
   `(hl-line-face ((,class (:background ,light-black))))
`(hl-line ((,class (:background ,light-black))))
...
`(org-code ((,class (:foreground ,cyberpunk-green-2))))
   ...
   `(org-done ((,class (:bold t :weight bold :foreground ,cyberpunk-blue-4 :family "Courier"
                              ))))
   `(org-todo ((,class (:bold t :foreground ,cyberpunk-jay-pink :weight bold :family "Courier"
                              ))))
   ...
   `(org-level-2 ((,class (:foreground ,cyberpunk-blue-5 :height 1.0))))
   `(org-level-3 ((,class (:foreground ,cyberpunk-green :height 1.0))))
