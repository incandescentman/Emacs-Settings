...
- ~M-x my-timeline-capture~ captures a date and event from any buffer, then returns to the current work. Capture leaves preexisting unsaved diary edits unsaved.
